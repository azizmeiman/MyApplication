...
public class highestContractPoster extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_highest_contract_poster);

        FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference myRef = database.getReference();

        listViewposter = (ListView) findViewById(R.id.highestContractPosterList);
        ...
        myRef.child("WorkerPoster").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                pAdapter = new PosterAdapter(highestContractPoster.this, posterList);
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(highestContractPoster.this, databaseError.getMessage(), Toast.LENGTH_LONG).show();
        ...
        listViewposter.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(highestContractPoster.this, viewPosterAdmin.class);
